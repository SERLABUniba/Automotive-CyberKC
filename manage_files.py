...
import csv
import sqlite3
from costants import MAPSETTINGS, CARSETTINGS, ATTACKPATH, DB, INDEX
...
def insertAttack(attackName, timestamp, carModel, attackType, capec):
    ...
    cur.execute(
        'INSERT INTO Attacks(AttackName, Timestamp, CarModel, AttackType, Status, CAPEC, CarBuilder, CarYear) VALUES(?, ?, ?, ?, "Open", ?, "Kia", "2021")',
        (attackName, timestamp, carModel, attackType, capec),
    )
